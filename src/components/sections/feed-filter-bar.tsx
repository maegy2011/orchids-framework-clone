...
export default function FeedFilterBar({ onCategoryChange }: { onCategoryChange?: (category: string) => void }) {
  ...
  return (
    <div className={`sticky ${stickyTop} z-[2010] w-full bg-background/90 backdrop-blur-md px-4 flex items-center h-[56px] border-b border-border transition-all duration-300`}>
